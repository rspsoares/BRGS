...
namespace BRGS.UI
{
    public partial class ObraManutencao : Form
    {
        ...
        private void ObraManutencao_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    btPlanejamentoEtapa.Enabled = false;
                    btGastosEtapa.Enabled = false;
                }
        ...
        private void btGastosEtapa_Click(object sender, EventArgs e)
        {
            ObraEtapa etapa = new ObraEtapa();
            int linhaGrid = 0;
            int idEtapaSelecionada = 0;
            ...
            ObraManutencao form = new ObraManutencao(etapa, false);
            form.ShowDialog();
