...
namespace BRGS.UI
{
    public partial class ManutencaoGeracaoOP : Form
    {
        ...
        public ManutencaoGeracaoOP(Manutencao _manutencaoSelecionada)
        {
            InitializeComponent();
            manutencaoSelecionada = _manutencaoSelecionada;
        }

        private void ManutencaoGeracaoOP_Load(object sender, EventArgs e)
        {
        ...
        private void btGerarOP_Click(object sender, EventArgs e)
        {
            ...
            if (msgRetorno == string.Empty)
            {
                ...
                {
                    idManutencao = manutencaoSelecionada.idManutencao,
                    idFrete = 0,
