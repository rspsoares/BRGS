    ...
    public partial class ClienteManutencao : Form
    {
        ...
        {            
            ...
            try
            {
                ...
                bizCliente.ExcluirContaBancaria(idConta);
        ...
        private void CarregarContasBancarias()
        {
            try
            {
                ...
                clienteSelecionado.lstContasBancarias = bizCliente.PesquisarClienteContaBancaria(new ClienteContaBancaria() { idCliente = clienteSelecionado.idCliente });

                foreach (ClienteContaBancaria itemConta in clienteSelecionado.lstContasBancarias.OrderBy(x => x.Banco).ToList())
                {
