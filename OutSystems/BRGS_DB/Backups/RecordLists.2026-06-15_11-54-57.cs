...
namespace OutSystems.NssBRGS_DB {
	...
	///  <code>OrdemPagamentoPDF</code>
	/// </summary>
	[Serializable()]
	public partial class RLOrdemPagamentoPDFRecordList: GenericRecordList<RCOrdemPagamentoPDFRecord>, IEnumerable, IEnumerator, ISerializable {
		public static void EnsureInitialized() {}

		protected override RCOrdemPagamentoPDFRecord GetElementDefaultValue() {
			return new RCOrdemPagamentoPDFRecord("");
		}

		public T[] ToArray<T>(Func<RCOrdemPagamentoPDFRecord, T> converter) {
			return ToArray(this, converter);
		}

		public static T[] ToArray<T>(RLOrdemPagamentoPDFRecordList recordlist, Func<RCOrdemPagamentoPDFRecord, T> converter) {
			return InnerToArray(recordlist, converter);
		}
		public static implicit operator RLOrdemPagamentoPDFRecordList(RCOrdemPagamentoPDFRecord[] array) {
			RLOrdemPagamentoPDFRecordList result = new RLOrdemPagamentoPDFRecordList();
			result.InnerFromArray(array);
			return result;
		}

		public static RLOrdemPagamentoPDFRecordList ToList<T>(T[] array, Func <T, RCOrdemPagamentoPDFRecord> converter) {
			RLOrdemPagamentoPDFRecordList result = new RLOrdemPagamentoPDFRecordList();
			result.InnerFromArray(array, converter);
			return result;
		}

		public static RLOrdemPagamentoPDFRecordList FromRestList<T>(RestList<T> restList, Func <T, RCOrdemPagamentoPDFRecord> converter) {
			RLOrdemPagamentoPDFRecordList result = new RLOrdemPagamentoPDFRecordList();
			result.InnerFromRestList(restList, converter);
			return result;
		}
		...
		/// Default Constructor
		/// </summary>
		public RLOrdemPagamentoPDFRecordList(): base() {
		}
		...
		/// <param name="trans"> IDbTransaction Parameter</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLOrdemPagamentoPDFRecordList(IDbTransaction trans): base(trans) {
		}
		...
		/// <param name="alternateReadDBMethod"> Alternate Read Method</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLOrdemPagamentoPDFRecordList(IDbTransaction trans, ReadDBMethodDelegate alternateReadDBMethod): this(trans) {
			this.alternateReadDBMethod = alternateReadDBMethod;
		}
		...
		/// <param name="info"> SerializationInfo</param>
		/// <param name="context"> StreamingContext</param>
		public RLOrdemPagamentoPDFRecordList(SerializationInfo info, StreamingContext context): base(info, context) {
		}
		...
		/// </summary>
		/// <returns>The new record list</returns>
		protected override OSList<RCOrdemPagamentoPDFRecord> NewList() {
			return new RLOrdemPagamentoPDFRecordList();
		}


	} // RLOrdemPagamentoPDFRecordList

	/// <summary>
	/// RecordList type <code>RLVW_COMBO_DESPESA_MOBILERecordList</code> that represents a record list of
	///  <code>VW_COMBO_DESPESA_MOBILE</code>
	/// </summary>
	[Serializable()]
	public partial class RLVW_COMBO_DESPESA_MOBILERecordList: GenericRecordList<RCVW_COMBO_DESPESA_MOBILERecord>, IEnumerable, IEnumerator, ISerializable {
		public static void EnsureInitialized() {}

		protected override RCVW_COMBO_DESPESA_MOBILERecord GetElementDefaultValue() {
			return new RCVW_COMBO_DESPESA_MOBILERecord("");
		}

		public T[] ToArray<T>(Func<RCVW_COMBO_DESPESA_MOBILERecord, T> converter) {
			return ToArray(this, converter);
		}

		public static T[] ToArray<T>(RLVW_COMBO_DESPESA_MOBILERecordList recordlist, Func<RCVW_COMBO_DESPESA_MOBILERecord, T> converter) {
			return InnerToArray(recordlist, converter);
		}
		public static implicit operator RLVW_COMBO_DESPESA_MOBILERecordList(RCVW_COMBO_DESPESA_MOBILERecord[] array) {
			RLVW_COMBO_DESPESA_MOBILERecordList result = new RLVW_COMBO_DESPESA_MOBILERecordList();
			result.InnerFromArray(array);
			return result;
		}

		public static RLVW_COMBO_DESPESA_MOBILERecordList ToList<T>(T[] array, Func <T, RCVW_COMBO_DESPESA_MOBILERecord> converter) {
			RLVW_COMBO_DESPESA_MOBILERecordList result = new RLVW_COMBO_DESPESA_MOBILERecordList();
			result.InnerFromArray(array, converter);
			return result;
		}

		public static RLVW_COMBO_DESPESA_MOBILERecordList FromRestList<T>(RestList<T> restList, Func <T, RCVW_COMBO_DESPESA_MOBILERecord> converter) {
			RLVW_COMBO_DESPESA_MOBILERecordList result = new RLVW_COMBO_DESPESA_MOBILERecordList();
			result.InnerFromRestList(restList, converter);
			return result;
		}
		...
		/// Default Constructor
		/// </summary>
		public RLVW_COMBO_DESPESA_MOBILERecordList(): base() {
		}
		...
		/// <param name="trans"> IDbTransaction Parameter</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLVW_COMBO_DESPESA_MOBILERecordList(IDbTransaction trans): base(trans) {
		}
		...
		/// <param name="alternateReadDBMethod"> Alternate Read Method</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLVW_COMBO_DESPESA_MOBILERecordList(IDbTransaction trans, ReadDBMethodDelegate alternateReadDBMethod): this(trans) {
			this.alternateReadDBMethod = alternateReadDBMethod;
		}
		...
		/// <param name="info"> SerializationInfo</param>
		/// <param name="context"> StreamingContext</param>
		public RLVW_COMBO_DESPESA_MOBILERecordList(SerializationInfo info, StreamingContext context): base(info, context) {
		}
		...
		/// </summary>
		/// <returns>The new record list</returns>
		protected override OSList<RCVW_COMBO_DESPESA_MOBILERecord> NewList() {
			return new RLVW_COMBO_DESPESA_MOBILERecordList();
		}


	} // RLVW_COMBO_DESPESA_MOBILERecordList

	/// <summary>
	/// RecordList type <code>RLVW_COMBO_UEN_MOBILERecordList</code> that represents a record list of
	///  <code>VW_COMBO_UEN_MOBILE</code>
	/// </summary>
	[Serializable()]
	public partial class RLVW_COMBO_UEN_MOBILERecordList: GenericRecordList<RCVW_COMBO_UEN_MOBILERecord>, IEnumerable, IEnumerator, ISerializable {
		public static void EnsureInitialized() {}

		protected override RCVW_COMBO_UEN_MOBILERecord GetElementDefaultValue() {
			return new RCVW_COMBO_UEN_MOBILERecord("");
		}

		public T[] ToArray<T>(Func<RCVW_COMBO_UEN_MOBILERecord, T> converter) {
			return ToArray(this, converter);
		}

		public static T[] ToArray<T>(RLVW_COMBO_UEN_MOBILERecordList recordlist, Func<RCVW_COMBO_UEN_MOBILERecord, T> converter) {
			return InnerToArray(recordlist, converter);
		}
		public static implicit operator RLVW_COMBO_UEN_MOBILERecordList(RCVW_COMBO_UEN_MOBILERecord[] array) {
			RLVW_COMBO_UEN_MOBILERecordList result = new RLVW_COMBO_UEN_MOBILERecordList();
			result.InnerFromArray(array);
			return result;
		}

		public static RLVW_COMBO_UEN_MOBILERecordList ToList<T>(T[] array, Func <T, RCVW_COMBO_UEN_MOBILERecord> converter) {
			RLVW_COMBO_UEN_MOBILERecordList result = new RLVW_COMBO_UEN_MOBILERecordList();
			result.InnerFromArray(array, converter);
			return result;
		}

		public static RLVW_COMBO_UEN_MOBILERecordList FromRestList<T>(RestList<T> restList, Func <T, RCVW_COMBO_UEN_MOBILERecord> converter) {
			RLVW_COMBO_UEN_MOBILERecordList result = new RLVW_COMBO_UEN_MOBILERecordList();
			result.InnerFromRestList(restList, converter);
			return result;
		}
		...
		/// Default Constructor
		/// </summary>
		public RLVW_COMBO_UEN_MOBILERecordList(): base() {
		}
		...
		/// <param name="trans"> IDbTransaction Parameter</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLVW_COMBO_UEN_MOBILERecordList(IDbTransaction trans): base(trans) {
		}
		...
		/// <param name="alternateReadDBMethod"> Alternate Read Method</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLVW_COMBO_UEN_MOBILERecordList(IDbTransaction trans, ReadDBMethodDelegate alternateReadDBMethod): this(trans) {
			this.alternateReadDBMethod = alternateReadDBMethod;
		}
		...
		/// <param name="info"> SerializationInfo</param>
		/// <param name="context"> StreamingContext</param>
		public RLVW_COMBO_UEN_MOBILERecordList(SerializationInfo info, StreamingContext context): base(info, context) {
		}
		...
		/// </summary>
		/// <returns>The new record list</returns>
		protected override OSList<RCVW_COMBO_UEN_MOBILERecord> NewList() {
			return new RLVW_COMBO_UEN_MOBILERecordList();
		}


	} // RLVW_COMBO_UEN_MOBILERecordList

	/// <summary>
	/// RecordList type <code>RLVW_COMBO_CENTROCUSTO_MOBILERecordList</code> that represents a record list
	///  of <code>VW_COMBO_CENTROCUSTO_MOBILE</code>
	/// </summary>
	[Serializable()]
	public partial class RLVW_COMBO_CENTROCUSTO_MOBILERecordList: GenericRecordList<RCVW_COMBO_CENTROCUSTO_MOBILERecord>, IEnumerable, IEnumerator, ISerializable {
		public static void EnsureInitialized() {}

		protected override RCVW_COMBO_CENTROCUSTO_MOBILERecord GetElementDefaultValue() {
			return new RCVW_COMBO_CENTROCUSTO_MOBILERecord("");
		}

		public T[] ToArray<T>(Func<RCVW_COMBO_CENTROCUSTO_MOBILERecord, T> converter) {
			return ToArray(this, converter);
		}

		public static T[] ToArray<T>(RLVW_COMBO_CENTROCUSTO_MOBILERecordList recordlist, Func<RCVW_COMBO_CENTROCUSTO_MOBILERecord, T> converter) {
			return InnerToArray(recordlist, converter);
		}
		public static implicit operator RLVW_COMBO_CENTROCUSTO_MOBILERecordList(RCVW_COMBO_CENTROCUSTO_MOBILERecord[] array) {
			RLVW_COMBO_CENTROCUSTO_MOBILERecordList result = new RLVW_COMBO_CENTROCUSTO_MOBILERecordList();
			result.InnerFromArray(array);
			return result;
		}

		public static RLVW_COMBO_CENTROCUSTO_MOBILERecordList ToList<T>(T[] array, Func <T, RCVW_COMBO_CENTROCUSTO_MOBILERecord> converter) {
			RLVW_COMBO_CENTROCUSTO_MOBILERecordList result = new RLVW_COMBO_CENTROCUSTO_MOBILERecordList();
			result.InnerFromArray(array, converter);
			return result;
		}

		public static RLVW_COMBO_CENTROCUSTO_MOBILERecordList FromRestList<T>(RestList<T> restList, Func <T, RCVW_COMBO_CENTROCUSTO_MOBILERecord> converter) {
			RLVW_COMBO_CENTROCUSTO_MOBILERecordList result = new RLVW_COMBO_CENTROCUSTO_MOBILERecordList();
			result.InnerFromRestList(restList, converter);
			return result;
		}
		...
		/// Default Constructor
		/// </summary>
		public RLVW_COMBO_CENTROCUSTO_MOBILERecordList(): base() {
		}
		...
		/// <param name="trans"> IDbTransaction Parameter</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLVW_COMBO_CENTROCUSTO_MOBILERecordList(IDbTransaction trans): base(trans) {
		}
		...
		/// <param name="alternateReadDBMethod"> Alternate Read Method</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLVW_COMBO_CENTROCUSTO_MOBILERecordList(IDbTransaction trans, ReadDBMethodDelegate alternateReadDBMethod): this(trans) {
			this.alternateReadDBMethod = alternateReadDBMethod;
		}
		...
		/// <param name="info"> SerializationInfo</param>
		/// <param name="context"> StreamingContext</param>
		public RLVW_COMBO_CENTROCUSTO_MOBILERecordList(SerializationInfo info, StreamingContext context): base(info, context) {
		}
		...
		/// </summary>
		/// <returns>The new record list</returns>
		protected override OSList<RCVW_COMBO_CENTROCUSTO_MOBILERecord> NewList() {
			return new RLVW_COMBO_CENTROCUSTO_MOBILERecordList();
		}


	} // RLVW_COMBO_CENTROCUSTO_MOBILERecordList

	/// <summary>
	/// RecordList type <code>RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList</code> that represents a record
	///  list of <code>VW_ORDEMPAGAMENTO_NOVONUMEROOP</code>
	/// </summary>
	[Serializable()]
	public partial class RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList: GenericRecordList<RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord>, IEnumerable, IEnumerator, ISerializable {
		public static void EnsureInitialized() {}

		protected override RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord GetElementDefaultValue() {
			return new RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord("");
		}

		public T[] ToArray<T>(Func<RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord, T> converter) {
			return ToArray(this, converter);
		}

		public static T[] ToArray<T>(RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList recordlist, Func<RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord, T> converter) {
			return InnerToArray(recordlist, converter);
		}
		public static implicit operator RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList(RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord[] array) {
			RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList result = new RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList();
			result.InnerFromArray(array);
			return result;
		}

		public static RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList ToList<T>(T[] array, Func <T, RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord> converter) {
			RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList result = new RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList();
			result.InnerFromArray(array, converter);
			return result;
		}

		public static RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList FromRestList<T>(RestList<T> restList, Func <T, RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord> converter) {
			RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList result = new RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList();
			result.InnerFromRestList(restList, converter);
			return result;
		}
		...
		/// Default Constructor
		/// </summary>
		public RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList(): base() {
		}
		...
		/// <param name="trans"> IDbTransaction Parameter</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList(IDbTransaction trans): base(trans) {
		}
		...
		/// <param name="alternateReadDBMethod"> Alternate Read Method</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList(IDbTransaction trans, ReadDBMethodDelegate alternateReadDBMethod): this(trans) {
			this.alternateReadDBMethod = alternateReadDBMethod;
		}
		...
		/// <param name="info"> SerializationInfo</param>
		/// <param name="context"> StreamingContext</param>
		public RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList(SerializationInfo info, StreamingContext context): base(info, context) {
		}
		...
		/// </summary>
		/// <returns>The new record list</returns>
		protected override OSList<RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord> NewList() {
			return new RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList();
		}


	} // RLVW_ORDEMPAGAMENTO_NOVONUMEROOPRecordList
}
