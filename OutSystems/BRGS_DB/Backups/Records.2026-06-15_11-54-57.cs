...
namespace OutSystems.NssBRGS_DB {
	...
	/// <summary>
	/// Structure <code>RCVW_Dashboard_EmpilhadeirasRecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_Dashboard_EmpilhadeirasRecord: ISerializable, ITypedRecord<RCVW_Dashboard_EmpilhadeirasRecord> {
		internal static readonly GlobalObjectKey IdVW_Dashboard_Empilhadeiras = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*W5wqkHfVO58wFhj547tSPg");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_Dashboard_Empilhadeiras")]
		public ENVW_Dashboard_EmpilhadeirasEntityRecord ssENVW_Dashboard_Empilhadeiras;


		public static implicit operator ENVW_Dashboard_EmpilhadeirasEntityRecord(RCVW_Dashboard_EmpilhadeirasRecord r) {
			return r.ssENVW_Dashboard_Empilhadeiras;
		}

		public static implicit operator RCVW_Dashboard_EmpilhadeirasRecord(ENVW_Dashboard_EmpilhadeirasEntityRecord r) {
			RCVW_Dashboard_EmpilhadeirasRecord res = new RCVW_Dashboard_EmpilhadeirasRecord(null);
			res.ssENVW_Dashboard_Empilhadeiras = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_Dashboard_Empilhadeiras.ChangedAttributes = value;
			}
			get {
				return ssENVW_Dashboard_Empilhadeiras.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_Dashboard_EmpilhadeirasRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_Empilhadeiras = new ENVW_Dashboard_EmpilhadeirasEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_Dashboard_Empilhadeiras.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_Dashboard_Empilhadeiras.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_Dashboard_Empilhadeiras.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_Dashboard_Empilhadeiras.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_Dashboard_EmpilhadeirasRecord r) {
			this = r;
		}


		public static bool operator == (RCVW_Dashboard_EmpilhadeirasRecord a, RCVW_Dashboard_EmpilhadeirasRecord b) {
			if (a.ssENVW_Dashboard_Empilhadeiras != b.ssENVW_Dashboard_Empilhadeiras) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_Dashboard_EmpilhadeirasRecord)) return false;
			return (this == (RCVW_Dashboard_EmpilhadeirasRecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_Dashboard_Empilhadeiras.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_Dashboard_EmpilhadeirasRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_Empilhadeiras = new ENVW_Dashboard_EmpilhadeirasEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_Dashboard_Empilhadeiras", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_Dashboard_Empilhadeiras' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_Dashboard_Empilhadeiras = (ENVW_Dashboard_EmpilhadeirasEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_Dashboard_Empilhadeiras.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_Dashboard_Empilhadeiras.InternalRecursiveSave();
		}


		public RCVW_Dashboard_EmpilhadeirasRecord Duplicate() {
			RCVW_Dashboard_EmpilhadeirasRecord t;
			t.ssENVW_Dashboard_Empilhadeiras = (ENVW_Dashboard_EmpilhadeirasEntityRecord) this.ssENVW_Dashboard_Empilhadeiras.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_Dashboard_Empilhadeiras.ToXml(this, recordElem, "VW_Dashboard_Empilhadeiras", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_dashboard_empilhadeiras") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_Dashboard_Empilhadeiras")) variable.Value = ssENVW_Dashboard_Empilhadeiras; else variable.Optimized = true;
				variable.SetFieldName("vw_dashboard_empilhadeiras");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_Empilhadeiras.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_Empilhadeiras.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_Dashboard_Empilhadeiras) {
				return ssENVW_Dashboard_Empilhadeiras;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_Dashboard_Empilhadeiras.FillFromOther((IRecord) other.AttributeGet(IdVW_Dashboard_Empilhadeiras));
		}
		public bool IsDefault() {
			RCVW_Dashboard_EmpilhadeirasRecord defaultStruct = new RCVW_Dashboard_EmpilhadeirasRecord(null);
			if (this.ssENVW_Dashboard_Empilhadeiras != defaultStruct.ssENVW_Dashboard_Empilhadeiras) return false;
			return true;
		}
	} // RCVW_Dashboard_EmpilhadeirasRecord

	/// <summary>
	/// Structure <code>RCVW_Dashboard_GeradoresRecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_Dashboard_GeradoresRecord: ISerializable, ITypedRecord<RCVW_Dashboard_GeradoresRecord> {
		internal static readonly GlobalObjectKey IdVW_Dashboard_Geradores = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*ZFqK9LHCeQvryMM3_P3__w");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_Dashboard_Geradores")]
		public ENVW_Dashboard_GeradoresEntityRecord ssENVW_Dashboard_Geradores;


		public static implicit operator ENVW_Dashboard_GeradoresEntityRecord(RCVW_Dashboard_GeradoresRecord r) {
			return r.ssENVW_Dashboard_Geradores;
		}

		public static implicit operator RCVW_Dashboard_GeradoresRecord(ENVW_Dashboard_GeradoresEntityRecord r) {
			RCVW_Dashboard_GeradoresRecord res = new RCVW_Dashboard_GeradoresRecord(null);
			res.ssENVW_Dashboard_Geradores = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_Dashboard_Geradores.ChangedAttributes = value;
			}
			get {
				return ssENVW_Dashboard_Geradores.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_Dashboard_GeradoresRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_Geradores = new ENVW_Dashboard_GeradoresEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_Dashboard_Geradores.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_Dashboard_Geradores.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_Dashboard_Geradores.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_Dashboard_Geradores.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_Dashboard_GeradoresRecord r) {
			this = r;
		}


		public static bool operator == (RCVW_Dashboard_GeradoresRecord a, RCVW_Dashboard_GeradoresRecord b) {
			if (a.ssENVW_Dashboard_Geradores != b.ssENVW_Dashboard_Geradores) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_Dashboard_GeradoresRecord)) return false;
			return (this == (RCVW_Dashboard_GeradoresRecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_Dashboard_Geradores.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_Dashboard_GeradoresRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_Geradores = new ENVW_Dashboard_GeradoresEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_Dashboard_Geradores", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_Dashboard_Geradores' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_Dashboard_Geradores = (ENVW_Dashboard_GeradoresEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_Dashboard_Geradores.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_Dashboard_Geradores.InternalRecursiveSave();
		}


		public RCVW_Dashboard_GeradoresRecord Duplicate() {
			RCVW_Dashboard_GeradoresRecord t;
			t.ssENVW_Dashboard_Geradores = (ENVW_Dashboard_GeradoresEntityRecord) this.ssENVW_Dashboard_Geradores.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_Dashboard_Geradores.ToXml(this, recordElem, "VW_Dashboard_Geradores", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_dashboard_geradores") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_Dashboard_Geradores")) variable.Value = ssENVW_Dashboard_Geradores; else variable.Optimized = true;
				variable.SetFieldName("vw_dashboard_geradores");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_Geradores.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_Geradores.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_Dashboard_Geradores) {
				return ssENVW_Dashboard_Geradores;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_Dashboard_Geradores.FillFromOther((IRecord) other.AttributeGet(IdVW_Dashboard_Geradores));
		}
		public bool IsDefault() {
			RCVW_Dashboard_GeradoresRecord defaultStruct = new RCVW_Dashboard_GeradoresRecord(null);
			if (this.ssENVW_Dashboard_Geradores != defaultStruct.ssENVW_Dashboard_Geradores) return false;
			return true;
		}
	} // RCVW_Dashboard_GeradoresRecord

	/// <summary>
	/// Structure <code>RCVW_Dashboard_OPsVencimentoRecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_Dashboard_OPsVencimentoRecord: ISerializable, ITypedRecord<RCVW_Dashboard_OPsVencimentoRecord> {
		internal static readonly GlobalObjectKey IdVW_Dashboard_OPsVencimento = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*MLUqhwL8Ty9qiTJ+YdQmfg");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_Dashboard_OPsVencimento")]
		public ENVW_Dashboard_OPsVencimentoEntityRecord ssENVW_Dashboard_OPsVencimento;


		public static implicit operator ENVW_Dashboard_OPsVencimentoEntityRecord(RCVW_Dashboard_OPsVencimentoRecord r) {
			return r.ssENVW_Dashboard_OPsVencimento;
		}

		public static implicit operator RCVW_Dashboard_OPsVencimentoRecord(ENVW_Dashboard_OPsVencimentoEntityRecord r) {
			RCVW_Dashboard_OPsVencimentoRecord res = new RCVW_Dashboard_OPsVencimentoRecord(null);
			res.ssENVW_Dashboard_OPsVencimento = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_Dashboard_OPsVencimento.ChangedAttributes = value;
			}
			get {
				return ssENVW_Dashboard_OPsVencimento.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_Dashboard_OPsVencimentoRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_OPsVencimento = new ENVW_Dashboard_OPsVencimentoEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_Dashboard_OPsVencimento.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_Dashboard_OPsVencimento.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_Dashboard_OPsVencimento.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_Dashboard_OPsVencimento.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_Dashboard_OPsVencimentoRecord r) {
			this = r;
		}


		public static bool operator == (RCVW_Dashboard_OPsVencimentoRecord a, RCVW_Dashboard_OPsVencimentoRecord b) {
			if (a.ssENVW_Dashboard_OPsVencimento != b.ssENVW_Dashboard_OPsVencimento) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_Dashboard_OPsVencimentoRecord)) return false;
			return (this == (RCVW_Dashboard_OPsVencimentoRecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_Dashboard_OPsVencimento.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_Dashboard_OPsVencimentoRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_OPsVencimento = new ENVW_Dashboard_OPsVencimentoEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_Dashboard_OPsVencimento", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_Dashboard_OPsVencimento' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_Dashboard_OPsVencimento = (ENVW_Dashboard_OPsVencimentoEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_Dashboard_OPsVencimento.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_Dashboard_OPsVencimento.InternalRecursiveSave();
		}


		public RCVW_Dashboard_OPsVencimentoRecord Duplicate() {
			RCVW_Dashboard_OPsVencimentoRecord t;
			t.ssENVW_Dashboard_OPsVencimento = (ENVW_Dashboard_OPsVencimentoEntityRecord) this.ssENVW_Dashboard_OPsVencimento.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_Dashboard_OPsVencimento.ToXml(this, recordElem, "VW_Dashboard_OPsVencimento", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_dashboard_opsvencimento") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_Dashboard_OPsVencimento")) variable.Value = ssENVW_Dashboard_OPsVencimento; else variable.Optimized = true;
				variable.SetFieldName("vw_dashboard_opsvencimento");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_OPsVencimento.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_OPsVencimento.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_Dashboard_OPsVencimento) {
				return ssENVW_Dashboard_OPsVencimento;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_Dashboard_OPsVencimento.FillFromOther((IRecord) other.AttributeGet(IdVW_Dashboard_OPsVencimento));
		}
		public bool IsDefault() {
			RCVW_Dashboard_OPsVencimentoRecord defaultStruct = new RCVW_Dashboard_OPsVencimentoRecord(null);
			if (this.ssENVW_Dashboard_OPsVencimento != defaultStruct.ssENVW_Dashboard_OPsVencimento) return false;
			return true;
		}
	} // RCVW_Dashboard_OPsVencimentoRecord

	/// <summary>
	/// Structure <code>RCVW_Dashboard_OPs_AnoRecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_Dashboard_OPs_AnoRecord: ISerializable, ITypedRecord<RCVW_Dashboard_OPs_AnoRecord> {
		internal static readonly GlobalObjectKey IdVW_Dashboard_OPs_Ano = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*t8ksoRNVqS_gjGfTO9mpDQ");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_Dashboard_OPs_Ano")]
		public ENVW_Dashboard_OPs_AnoEntityRecord ssENVW_Dashboard_OPs_Ano;


		public static implicit operator ENVW_Dashboard_OPs_AnoEntityRecord(RCVW_Dashboard_OPs_AnoRecord r) {
			return r.ssENVW_Dashboard_OPs_Ano;
		}

		public static implicit operator RCVW_Dashboard_OPs_AnoRecord(ENVW_Dashboard_OPs_AnoEntityRecord r) {
			RCVW_Dashboard_OPs_AnoRecord res = new RCVW_Dashboard_OPs_AnoRecord(null);
			res.ssENVW_Dashboard_OPs_Ano = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_Dashboard_OPs_Ano.ChangedAttributes = value;
			}
			get {
				return ssENVW_Dashboard_OPs_Ano.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_Dashboard_OPs_AnoRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_OPs_Ano = new ENVW_Dashboard_OPs_AnoEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_Dashboard_OPs_Ano.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_Dashboard_OPs_Ano.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_Dashboard_OPs_Ano.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_Dashboard_OPs_Ano.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_Dashboard_OPs_AnoRecord r) {
			this = r;
		}


		public static bool operator == (RCVW_Dashboard_OPs_AnoRecord a, RCVW_Dashboard_OPs_AnoRecord b) {
			if (a.ssENVW_Dashboard_OPs_Ano != b.ssENVW_Dashboard_OPs_Ano) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_Dashboard_OPs_AnoRecord)) return false;
			return (this == (RCVW_Dashboard_OPs_AnoRecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_Dashboard_OPs_Ano.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_Dashboard_OPs_AnoRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_OPs_Ano = new ENVW_Dashboard_OPs_AnoEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_Dashboard_OPs_Ano", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_Dashboard_OPs_Ano' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_Dashboard_OPs_Ano = (ENVW_Dashboard_OPs_AnoEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_Dashboard_OPs_Ano.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_Dashboard_OPs_Ano.InternalRecursiveSave();
		}


		public RCVW_Dashboard_OPs_AnoRecord Duplicate() {
			RCVW_Dashboard_OPs_AnoRecord t;
			t.ssENVW_Dashboard_OPs_Ano = (ENVW_Dashboard_OPs_AnoEntityRecord) this.ssENVW_Dashboard_OPs_Ano.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_Dashboard_OPs_Ano.ToXml(this, recordElem, "VW_Dashboard_OPs_Ano", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_dashboard_ops_ano") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_Dashboard_OPs_Ano")) variable.Value = ssENVW_Dashboard_OPs_Ano; else variable.Optimized = true;
				variable.SetFieldName("vw_dashboard_ops_ano");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_OPs_Ano.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_OPs_Ano.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_Dashboard_OPs_Ano) {
				return ssENVW_Dashboard_OPs_Ano;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_Dashboard_OPs_Ano.FillFromOther((IRecord) other.AttributeGet(IdVW_Dashboard_OPs_Ano));
		}
		public bool IsDefault() {
			RCVW_Dashboard_OPs_AnoRecord defaultStruct = new RCVW_Dashboard_OPs_AnoRecord(null);
			if (this.ssENVW_Dashboard_OPs_Ano != defaultStruct.ssENVW_Dashboard_OPs_Ano) return false;
			return true;
		}
	} // RCVW_Dashboard_OPs_AnoRecord

	/// <summary>
	/// Structure <code>RCVW_Dashboard_OPs_CategoriaRecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_Dashboard_OPs_CategoriaRecord: ISerializable, ITypedRecord<RCVW_Dashboard_OPs_CategoriaRecord> {
		internal static readonly GlobalObjectKey IdVW_Dashboard_OPs_Categoria = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*eB1qxKnLrElmRquVrUo7UQ");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_Dashboard_OPs_Categoria")]
		public ENVW_Dashboard_OPs_CategoriaEntityRecord ssENVW_Dashboard_OPs_Categoria;


		public static implicit operator ENVW_Dashboard_OPs_CategoriaEntityRecord(RCVW_Dashboard_OPs_CategoriaRecord r) {
			return r.ssENVW_Dashboard_OPs_Categoria;
		}

		public static implicit operator RCVW_Dashboard_OPs_CategoriaRecord(ENVW_Dashboard_OPs_CategoriaEntityRecord r) {
			RCVW_Dashboard_OPs_CategoriaRecord res = new RCVW_Dashboard_OPs_CategoriaRecord(null);
			res.ssENVW_Dashboard_OPs_Categoria = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_Dashboard_OPs_Categoria.ChangedAttributes = value;
			}
			get {
				return ssENVW_Dashboard_OPs_Categoria.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_Dashboard_OPs_CategoriaRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_OPs_Categoria = new ENVW_Dashboard_OPs_CategoriaEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_Dashboard_OPs_Categoria.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_Dashboard_OPs_Categoria.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_Dashboard_OPs_Categoria.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_Dashboard_OPs_Categoria.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_Dashboard_OPs_CategoriaRecord r) {
			this = r;
		}


		public static bool operator == (RCVW_Dashboard_OPs_CategoriaRecord a, RCVW_Dashboard_OPs_CategoriaRecord b) {
			if (a.ssENVW_Dashboard_OPs_Categoria != b.ssENVW_Dashboard_OPs_Categoria) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_Dashboard_OPs_CategoriaRecord)) return false;
			return (this == (RCVW_Dashboard_OPs_CategoriaRecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_Dashboard_OPs_Categoria.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_Dashboard_OPs_CategoriaRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_Dashboard_OPs_Categoria = new ENVW_Dashboard_OPs_CategoriaEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_Dashboard_OPs_Categoria", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_Dashboard_OPs_Categoria' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_Dashboard_OPs_Categoria = (ENVW_Dashboard_OPs_CategoriaEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_Dashboard_OPs_Categoria.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_Dashboard_OPs_Categoria.InternalRecursiveSave();
		}


		public RCVW_Dashboard_OPs_CategoriaRecord Duplicate() {
			RCVW_Dashboard_OPs_CategoriaRecord t;
			t.ssENVW_Dashboard_OPs_Categoria = (ENVW_Dashboard_OPs_CategoriaEntityRecord) this.ssENVW_Dashboard_OPs_Categoria.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_Dashboard_OPs_Categoria.ToXml(this, recordElem, "VW_Dashboard_OPs_Categoria", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_dashboard_ops_categoria") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_Dashboard_OPs_Categoria")) variable.Value = ssENVW_Dashboard_OPs_Categoria; else variable.Optimized = true;
				variable.SetFieldName("vw_dashboard_ops_categoria");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_OPs_Categoria.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_Dashboard_OPs_Categoria.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_Dashboard_OPs_Categoria) {
				return ssENVW_Dashboard_OPs_Categoria;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_Dashboard_OPs_Categoria.FillFromOther((IRecord) other.AttributeGet(IdVW_Dashboard_OPs_Categoria));
		}
		public bool IsDefault() {
			RCVW_Dashboard_OPs_CategoriaRecord defaultStruct = new RCVW_Dashboard_OPs_CategoriaRecord(null);
			if (this.ssENVW_Dashboard_OPs_Categoria != defaultStruct.ssENVW_Dashboard_OPs_Categoria) return false;
			return true;
		}
	...
	/// </summary>
	[Serializable()]
	public partial struct RCOrdemPagamentoPDFRecord: ISerializable, ITypedRecord<RCOrdemPagamentoPDFRecord> {
		internal static readonly GlobalObjectKey IdOrdemPagamentoPDF = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*BYK1kuksE8+QloP5vMIeAg");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("OrdemPagamentoPDF")]
		public ENOrdemPagamentoPDFEntityRecord ssENOrdemPagamentoPDF;


		public static implicit operator ENOrdemPagamentoPDFEntityRecord(RCOrdemPagamentoPDFRecord r) {
			return r.ssENOrdemPagamentoPDF;
		}

		public static implicit operator RCOrdemPagamentoPDFRecord(ENOrdemPagamentoPDFEntityRecord r) {
			RCOrdemPagamentoPDFRecord res = new RCOrdemPagamentoPDFRecord(null);
			res.ssENOrdemPagamentoPDF = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENOrdemPagamentoPDF.ChangedAttributes = value;
			}
			get {
				return ssENOrdemPagamentoPDF.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCOrdemPagamentoPDFRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENOrdemPagamentoPDF = new ENOrdemPagamentoPDFEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENOrdemPagamentoPDF.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENOrdemPagamentoPDF.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENOrdemPagamentoPDF.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENOrdemPagamentoPDF.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCOrdemPagamentoPDFRecord r) {
			this = r;
		}


		public static bool operator == (RCOrdemPagamentoPDFRecord a, RCOrdemPagamentoPDFRecord b) {
			if (a.ssENOrdemPagamentoPDF != b.ssENOrdemPagamentoPDF) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCOrdemPagamentoPDFRecord)) return false;
			return (this == (RCOrdemPagamentoPDFRecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENOrdemPagamentoPDF.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCOrdemPagamentoPDFRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENOrdemPagamentoPDF = new ENOrdemPagamentoPDFEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENOrdemPagamentoPDF", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENOrdemPagamentoPDF' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENOrdemPagamentoPDF = (ENOrdemPagamentoPDFEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENOrdemPagamentoPDF.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENOrdemPagamentoPDF.InternalRecursiveSave();
		}


		public RCOrdemPagamentoPDFRecord Duplicate() {
			RCOrdemPagamentoPDFRecord t;
			t.ssENOrdemPagamentoPDF = (ENOrdemPagamentoPDFEntityRecord) this.ssENOrdemPagamentoPDF.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENOrdemPagamentoPDF.ToXml(this, recordElem, "OrdemPagamentoPDF", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "ordempagamentopdf") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".OrdemPagamentoPDF")) variable.Value = ssENOrdemPagamentoPDF; else variable.Optimized = true;
				variable.SetFieldName("ordempagamentopdf");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENOrdemPagamentoPDF.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENOrdemPagamentoPDF.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdOrdemPagamentoPDF) {
				return ssENOrdemPagamentoPDF;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENOrdemPagamentoPDF.FillFromOther((IRecord) other.AttributeGet(IdOrdemPagamentoPDF));
		}
		public bool IsDefault() {
			RCOrdemPagamentoPDFRecord defaultStruct = new RCOrdemPagamentoPDFRecord(null);
			if (this.ssENOrdemPagamentoPDF != defaultStruct.ssENOrdemPagamentoPDF) return false;
			return true;
		}
	} // RCOrdemPagamentoPDFRecord

	/// <summary>
	/// Structure <code>RCVW_COMBO_DESPESA_MOBILERecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_COMBO_DESPESA_MOBILERecord: ISerializable, ITypedRecord<RCVW_COMBO_DESPESA_MOBILERecord> {
		internal static readonly GlobalObjectKey IdVW_COMBO_DESPESA_MOBILE = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*PqKQnENmq9g9VeRktNJ4NA");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_COMBO_DESPESA_MOBILE")]
		public ENVW_COMBO_DESPESA_MOBILEEntityRecord ssENVW_COMBO_DESPESA_MOBILE;


		public static implicit operator ENVW_COMBO_DESPESA_MOBILEEntityRecord(RCVW_COMBO_DESPESA_MOBILERecord r) {
			return r.ssENVW_COMBO_DESPESA_MOBILE;
		}

		public static implicit operator RCVW_COMBO_DESPESA_MOBILERecord(ENVW_COMBO_DESPESA_MOBILEEntityRecord r) {
			RCVW_COMBO_DESPESA_MOBILERecord res = new RCVW_COMBO_DESPESA_MOBILERecord(null);
			res.ssENVW_COMBO_DESPESA_MOBILE = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_COMBO_DESPESA_MOBILE.ChangedAttributes = value;
			}
			get {
				return ssENVW_COMBO_DESPESA_MOBILE.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_COMBO_DESPESA_MOBILERecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_COMBO_DESPESA_MOBILE = new ENVW_COMBO_DESPESA_MOBILEEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_COMBO_DESPESA_MOBILE.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_COMBO_DESPESA_MOBILE.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_COMBO_DESPESA_MOBILE.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_COMBO_DESPESA_MOBILE.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_COMBO_DESPESA_MOBILERecord r) {
			this = r;
		}


		public static bool operator == (RCVW_COMBO_DESPESA_MOBILERecord a, RCVW_COMBO_DESPESA_MOBILERecord b) {
			if (a.ssENVW_COMBO_DESPESA_MOBILE != b.ssENVW_COMBO_DESPESA_MOBILE) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_COMBO_DESPESA_MOBILERecord)) return false;
			return (this == (RCVW_COMBO_DESPESA_MOBILERecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_COMBO_DESPESA_MOBILE.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_COMBO_DESPESA_MOBILERecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_COMBO_DESPESA_MOBILE = new ENVW_COMBO_DESPESA_MOBILEEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_COMBO_DESPESA_MOBILE", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_COMBO_DESPESA_MOBILE' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_COMBO_DESPESA_MOBILE = (ENVW_COMBO_DESPESA_MOBILEEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_COMBO_DESPESA_MOBILE.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_COMBO_DESPESA_MOBILE.InternalRecursiveSave();
		}


		public RCVW_COMBO_DESPESA_MOBILERecord Duplicate() {
			RCVW_COMBO_DESPESA_MOBILERecord t;
			t.ssENVW_COMBO_DESPESA_MOBILE = (ENVW_COMBO_DESPESA_MOBILEEntityRecord) this.ssENVW_COMBO_DESPESA_MOBILE.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_COMBO_DESPESA_MOBILE.ToXml(this, recordElem, "VW_COMBO_DESPESA_MOBILE", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_combo_despesa_mobile") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_COMBO_DESPESA_MOBILE")) variable.Value = ssENVW_COMBO_DESPESA_MOBILE; else variable.Optimized = true;
				variable.SetFieldName("vw_combo_despesa_mobile");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_COMBO_DESPESA_MOBILE.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_COMBO_DESPESA_MOBILE.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_COMBO_DESPESA_MOBILE) {
				return ssENVW_COMBO_DESPESA_MOBILE;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_COMBO_DESPESA_MOBILE.FillFromOther((IRecord) other.AttributeGet(IdVW_COMBO_DESPESA_MOBILE));
		}
		public bool IsDefault() {
			RCVW_COMBO_DESPESA_MOBILERecord defaultStruct = new RCVW_COMBO_DESPESA_MOBILERecord(null);
			if (this.ssENVW_COMBO_DESPESA_MOBILE != defaultStruct.ssENVW_COMBO_DESPESA_MOBILE) return false;
			return true;
		}
	} // RCVW_COMBO_DESPESA_MOBILERecord

	/// <summary>
	/// Structure <code>RCVW_COMBO_UEN_MOBILERecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_COMBO_UEN_MOBILERecord: ISerializable, ITypedRecord<RCVW_COMBO_UEN_MOBILERecord> {
		internal static readonly GlobalObjectKey IdVW_COMBO_UEN_MOBILE = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*UkQRhhOGCea5iNVqkGkeXA");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_COMBO_UEN_MOBILE")]
		public ENVW_COMBO_UEN_MOBILEEntityRecord ssENVW_COMBO_UEN_MOBILE;


		public static implicit operator ENVW_COMBO_UEN_MOBILEEntityRecord(RCVW_COMBO_UEN_MOBILERecord r) {
			return r.ssENVW_COMBO_UEN_MOBILE;
		}

		public static implicit operator RCVW_COMBO_UEN_MOBILERecord(ENVW_COMBO_UEN_MOBILEEntityRecord r) {
			RCVW_COMBO_UEN_MOBILERecord res = new RCVW_COMBO_UEN_MOBILERecord(null);
			res.ssENVW_COMBO_UEN_MOBILE = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_COMBO_UEN_MOBILE.ChangedAttributes = value;
			}
			get {
				return ssENVW_COMBO_UEN_MOBILE.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_COMBO_UEN_MOBILERecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_COMBO_UEN_MOBILE = new ENVW_COMBO_UEN_MOBILEEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_COMBO_UEN_MOBILE.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_COMBO_UEN_MOBILE.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_COMBO_UEN_MOBILE.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_COMBO_UEN_MOBILE.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_COMBO_UEN_MOBILERecord r) {
			this = r;
		}


		public static bool operator == (RCVW_COMBO_UEN_MOBILERecord a, RCVW_COMBO_UEN_MOBILERecord b) {
			if (a.ssENVW_COMBO_UEN_MOBILE != b.ssENVW_COMBO_UEN_MOBILE) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_COMBO_UEN_MOBILERecord)) return false;
			return (this == (RCVW_COMBO_UEN_MOBILERecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_COMBO_UEN_MOBILE.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_COMBO_UEN_MOBILERecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_COMBO_UEN_MOBILE = new ENVW_COMBO_UEN_MOBILEEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_COMBO_UEN_MOBILE", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_COMBO_UEN_MOBILE' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_COMBO_UEN_MOBILE = (ENVW_COMBO_UEN_MOBILEEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_COMBO_UEN_MOBILE.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_COMBO_UEN_MOBILE.InternalRecursiveSave();
		}


		public RCVW_COMBO_UEN_MOBILERecord Duplicate() {
			RCVW_COMBO_UEN_MOBILERecord t;
			t.ssENVW_COMBO_UEN_MOBILE = (ENVW_COMBO_UEN_MOBILEEntityRecord) this.ssENVW_COMBO_UEN_MOBILE.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_COMBO_UEN_MOBILE.ToXml(this, recordElem, "VW_COMBO_UEN_MOBILE", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_combo_uen_mobile") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_COMBO_UEN_MOBILE")) variable.Value = ssENVW_COMBO_UEN_MOBILE; else variable.Optimized = true;
				variable.SetFieldName("vw_combo_uen_mobile");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_COMBO_UEN_MOBILE.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_COMBO_UEN_MOBILE.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_COMBO_UEN_MOBILE) {
				return ssENVW_COMBO_UEN_MOBILE;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_COMBO_UEN_MOBILE.FillFromOther((IRecord) other.AttributeGet(IdVW_COMBO_UEN_MOBILE));
		}
		public bool IsDefault() {
			RCVW_COMBO_UEN_MOBILERecord defaultStruct = new RCVW_COMBO_UEN_MOBILERecord(null);
			if (this.ssENVW_COMBO_UEN_MOBILE != defaultStruct.ssENVW_COMBO_UEN_MOBILE) return false;
			return true;
		}
	} // RCVW_COMBO_UEN_MOBILERecord

	/// <summary>
	/// Structure <code>RCVW_COMBO_CENTROCUSTO_MOBILERecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_COMBO_CENTROCUSTO_MOBILERecord: ISerializable, ITypedRecord<RCVW_COMBO_CENTROCUSTO_MOBILERecord> {
		internal static readonly GlobalObjectKey IdVW_COMBO_CENTROCUSTO_MOBILE = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*_Bw6kc50vklOh0l3TM4OfQ");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_COMBO_CENTROCUSTO_MOBILE")]
		public ENVW_COMBO_CENTROCUSTO_MOBILEEntityRecord ssENVW_COMBO_CENTROCUSTO_MOBILE;


		public static implicit operator ENVW_COMBO_CENTROCUSTO_MOBILEEntityRecord(RCVW_COMBO_CENTROCUSTO_MOBILERecord r) {
			return r.ssENVW_COMBO_CENTROCUSTO_MOBILE;
		}

		public static implicit operator RCVW_COMBO_CENTROCUSTO_MOBILERecord(ENVW_COMBO_CENTROCUSTO_MOBILEEntityRecord r) {
			RCVW_COMBO_CENTROCUSTO_MOBILERecord res = new RCVW_COMBO_CENTROCUSTO_MOBILERecord(null);
			res.ssENVW_COMBO_CENTROCUSTO_MOBILE = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_COMBO_CENTROCUSTO_MOBILE.ChangedAttributes = value;
			}
			get {
				return ssENVW_COMBO_CENTROCUSTO_MOBILE.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_COMBO_CENTROCUSTO_MOBILERecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_COMBO_CENTROCUSTO_MOBILE = new ENVW_COMBO_CENTROCUSTO_MOBILEEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_COMBO_CENTROCUSTO_MOBILE.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_COMBO_CENTROCUSTO_MOBILE.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_COMBO_CENTROCUSTO_MOBILE.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_COMBO_CENTROCUSTO_MOBILE.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_COMBO_CENTROCUSTO_MOBILERecord r) {
			this = r;
		}


		public static bool operator == (RCVW_COMBO_CENTROCUSTO_MOBILERecord a, RCVW_COMBO_CENTROCUSTO_MOBILERecord b) {
			if (a.ssENVW_COMBO_CENTROCUSTO_MOBILE != b.ssENVW_COMBO_CENTROCUSTO_MOBILE) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_COMBO_CENTROCUSTO_MOBILERecord)) return false;
			return (this == (RCVW_COMBO_CENTROCUSTO_MOBILERecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_COMBO_CENTROCUSTO_MOBILE.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_COMBO_CENTROCUSTO_MOBILERecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_COMBO_CENTROCUSTO_MOBILE = new ENVW_COMBO_CENTROCUSTO_MOBILEEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_COMBO_CENTROCUSTO_MOBILE", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_COMBO_CENTROCUSTO_MOBILE' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_COMBO_CENTROCUSTO_MOBILE = (ENVW_COMBO_CENTROCUSTO_MOBILEEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_COMBO_CENTROCUSTO_MOBILE.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_COMBO_CENTROCUSTO_MOBILE.InternalRecursiveSave();
		}


		public RCVW_COMBO_CENTROCUSTO_MOBILERecord Duplicate() {
			RCVW_COMBO_CENTROCUSTO_MOBILERecord t;
			t.ssENVW_COMBO_CENTROCUSTO_MOBILE = (ENVW_COMBO_CENTROCUSTO_MOBILEEntityRecord) this.ssENVW_COMBO_CENTROCUSTO_MOBILE.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_COMBO_CENTROCUSTO_MOBILE.ToXml(this, recordElem, "VW_COMBO_CENTROCUSTO_MOBILE", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_combo_centrocusto_mobile") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_COMBO_CENTROCUSTO_MOBILE")) variable.Value = ssENVW_COMBO_CENTROCUSTO_MOBILE; else variable.Optimized = true;
				variable.SetFieldName("vw_combo_centrocusto_mobile");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_COMBO_CENTROCUSTO_MOBILE.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_COMBO_CENTROCUSTO_MOBILE.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_COMBO_CENTROCUSTO_MOBILE) {
				return ssENVW_COMBO_CENTROCUSTO_MOBILE;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_COMBO_CENTROCUSTO_MOBILE.FillFromOther((IRecord) other.AttributeGet(IdVW_COMBO_CENTROCUSTO_MOBILE));
		}
		public bool IsDefault() {
			RCVW_COMBO_CENTROCUSTO_MOBILERecord defaultStruct = new RCVW_COMBO_CENTROCUSTO_MOBILERecord(null);
			if (this.ssENVW_COMBO_CENTROCUSTO_MOBILE != defaultStruct.ssENVW_COMBO_CENTROCUSTO_MOBILE) return false;
			return true;
		}
	} // RCVW_COMBO_CENTROCUSTO_MOBILERecord

	/// <summary>
	/// Structure <code>RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord: ISerializable, ITypedRecord<RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord> {
		internal static readonly GlobalObjectKey IdVW_ORDEMPAGAMENTO_NOVONUMEROOP = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*4LSR9Mtwtjl2E0eBG5CSlw");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("VW_ORDEMPAGAMENTO_NOVONUMEROOP")]
		public ENVW_ORDEMPAGAMENTO_NOVONUMEROOPEntityRecord ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP;


		public static implicit operator ENVW_ORDEMPAGAMENTO_NOVONUMEROOPEntityRecord(RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord r) {
			return r.ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP;
		}

		public static implicit operator RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord(ENVW_ORDEMPAGAMENTO_NOVONUMEROOPEntityRecord r) {
			RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord res = new RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord(null);
			res.ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.ChangedAttributes = value;
			}
			get {
				return ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP = new ENVW_ORDEMPAGAMENTO_NOVONUMEROOPEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord r) {
			this = r;
		}


		public static bool operator == (RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord a, RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord b) {
			if (a.ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP != b.ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord)) return false;
			return (this == (RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP = new ENVW_ORDEMPAGAMENTO_NOVONUMEROOPEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP = (ENVW_ORDEMPAGAMENTO_NOVONUMEROOPEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.InternalRecursiveSave();
		}


		public RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord Duplicate() {
			RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord t;
			t.ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP = (ENVW_ORDEMPAGAMENTO_NOVONUMEROOPEntityRecord) this.ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.ToXml(this, recordElem, "VW_ORDEMPAGAMENTO_NOVONUMEROOP", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "vw_ordempagamento_novonumeroop") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".VW_ORDEMPAGAMENTO_NOVONUMEROOP")) variable.Value = ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP; else variable.Optimized = true;
				variable.SetFieldName("vw_ordempagamento_novonumeroop");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdVW_ORDEMPAGAMENTO_NOVONUMEROOP) {
				return ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP.FillFromOther((IRecord) other.AttributeGet(IdVW_ORDEMPAGAMENTO_NOVONUMEROOP));
		}
		public bool IsDefault() {
			RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord defaultStruct = new RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord(null);
			if (this.ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP != defaultStruct.ssENVW_ORDEMPAGAMENTO_NOVONUMEROOP) return false;
			return true;
		}
	} // RCVW_ORDEMPAGAMENTO_NOVONUMEROOPRecord
}
